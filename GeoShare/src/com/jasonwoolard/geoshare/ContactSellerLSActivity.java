...
public class ContactSellerLSActivity extends Activity {
	...
	String mTAG = "ContactSellerLSActivity";
	
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_contact_seller_ls);
	    getActionBar().setDisplayHomeAsUpEnabled(true);

		mSellerName = (TextView) findViewById(R.id.textView_contactSellerLSSellersName);
		mItemTitle = (TextView) findViewById(R.id.textView_contactSellerLSSubject);
		mMessageDetails = (EditText) findViewById(R.id.editText_contactSellerLSMessageField);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.contact_seller_ls, menu);
		return true;
	}
	@Override
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		{
		case R.id.action_send_message_ls:
